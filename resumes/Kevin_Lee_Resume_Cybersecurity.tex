...
Security-focused Software Engineer with 10+ years of experience protecting public-sector and critical-infrastructure systems. Delivered 500+ cyber threat intelligence cases annually and penetration testing, red teaming, vulnerability analysis, and remediation consulting for 200+ public institutions. Combines software development and incident response with current UC Davis M.S. research applying AI and machine learning to cyber threat detection.
\end{rSection}
...
\begin{itemize}
    \itemsep -4pt {}
    \item Built a cyber threat intelligence (CTI) collection system and analyzed 500+ threat cases annually across malware, attack evidence, and APT activity.
    \item Coordinated analysis of cyberattacks affecting critical infrastructure and disseminated timely threat-intelligence memoranda and remediation guidance to allied government agencies in the U.S., U.K., and Europe.
...
\begin{itemize}
    \itemsep -4pt {}
    \item Delivered penetration testing, red teaming, vulnerability analysis, and remediation consulting to 50+ public institutions annually (200+ total).
    \item Assessed networks and software supporting nuclear and thermal power, railway control, and power systems, including security risks in high-consequence operational environments.
    \item Translated exploitable findings into technical guidance and prioritized remediation actions for public-sector stakeholders.
\end{itemize}
